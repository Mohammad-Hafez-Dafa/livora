...
export function PropertyDetailsClient({ property }: PropertyDetailsClientProps) {
  ...
  const typeLabel = language === "ar" ? (property.typeAr || property.type) : property.type;
  const features = language === "ar" ? (property.featuresAr || property.features) : property.features;
  ...
  return (
    <div className="min-h-screen">
      ...
      <PageHeader
        ...
        descriptionAr={property.locationAr}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                ...
                {property.paymentPlans && (
                  <div className="mb-8">
                    <h2 className="font-serif text-2xl font-bold mb-4">
                      {t("Payment Plans", "خطط الدفع")}
                    </h2>
                    <p className="text-muted-foreground">
                      {language === "ar" ? (property.paymentPlansAr || property.paymentPlans) : property.paymentPlans}
                    </p>
                  </div>
                )}
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-24 bg-card p-6 rounded-lg border">
                  ...
                  <div className="space-y-4 mb-6">
                    <a
                      href="tel:+201055119927"
                      className="flex items-center gap-3 p-3 rounded-lg hover:bg-muted transition-colors"
                    >
                      <Phone className="h-5 w-5 text-gold" />
                      <span dir="ltr">+20 10 55 11 99 27</span>
                    </a>
                    <a
                      href="tel:+971542522769"
                      className="flex items-center gap-3 p-3 rounded-lg hover:bg-muted transition-colors"
                    >
                      <Phone className="h-5 w-5 text-gold" />
